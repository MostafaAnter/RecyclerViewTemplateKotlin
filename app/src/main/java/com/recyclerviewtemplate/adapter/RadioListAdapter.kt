 ...
 */
class RadioListAdapter(private val mContext: Context, private var modelList: ArrayList<AbstractModel>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.item_radio_list, viewGroup, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is ViewHolder) {
            ...
            genericViewHolder.radioList.isChecked = position == lastCheckedPosition
            genericViewHolder.radioList.setOnClickListener { view ->
                lastCheckedPosition = position
                notifyItemRangeChanged(0, modelList.size)
                mItemClickListener!!.onItemClick(view, position, modelList[position])
            }
        }
    }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            radioList = itemView.findViewById<View>(R.id.radio_list) as RadioButton
            itemView.setOnClickListener {
                lastCheckedPosition = adapterPosition
                notifyItemRangeChanged(0, modelList.size)
                mItemClickListener!!.onItemClick(itemView, adapterPosition, modelList[adapterPosition])
            }
        }
    }
}