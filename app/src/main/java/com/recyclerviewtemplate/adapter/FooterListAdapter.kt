 ...
 */
class FooterListAdapter(private val mContext: Context, private var modelList: ArrayList<AbstractModel>, private val mFooterTitle: String) : RecyclerView.Adapter<RecyclerView.ViewHolder?>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == TYPE_FOOTER) {
            ...
            val v = LayoutInflater.from(parent.context).inflate(R.layout.item_footer_list, parent, false)
            return ViewHolder(v)
        }
    }
