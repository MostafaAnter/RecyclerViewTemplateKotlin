 ...
 */
class HeaderListAdapter(private val mContext: Context, private var modelList: ArrayList<AbstractModel>, private val mHeaderTitle: String) : RecyclerView.Adapter<RecyclerView.ViewHolder?>() {
