 ...
 */
class HeaderFooterGridAdapter(private val mContext: Context, private var modelList: ArrayList<AbstractModel>, private val mHeaderTitle: String, private val mFooterTitle: String) : RecyclerView.Adapter<RecyclerView.ViewHolder?>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == TYPE_HEADER) {
            ...
            val v = LayoutInflater.from(parent.context).inflate(R.layout.item_header_footer_grid, parent, false)
            return ViewHolder(v)
        }
    }
