...
import com.recyclerviewtemplate.adapter.FooterListAdapter
import java.util.*

class FooterListActivity : AppCompatActivity() {
    private var recyclerView: RecyclerView? = null
    private var toolbar: Toolbar? = null
    private var swipeRefreshRecyclerList: SwipeRefreshLayout? = null
    private var fab: FloatingActionButton? = null
    private var mAdapter: FooterListAdapter? = null
    ...
    private fun setAdapter() {
        ...
        mAdapter = FooterListAdapter(this@FooterListActivity, modelList, "Footer")
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(this@FooterListActivity, R.drawable.divider_recyclerview)!!)
        recyclerView!!.addItemDecoration(dividerItemDecoration)
        recyclerView!!.adapter = mAdapter
        mAdapter!!.SetOnItemClickListener(object : FooterListAdapter.OnItemClickListener {
            override fun onItemClick(view: View?, position: Int, model: AbstractModel?) {

                //handle item click events here
                Toast.makeText(this@FooterListActivity, "Hey " + model!!.title, Toast.LENGTH_SHORT).show()
            }
        })
        mAdapter!!.SetOnFooterClickListener(object : FooterListAdapter.OnFooterClickListener {
            override fun onFooterClick(view: View?, footerTitle: String?) {

                //handle item click events here
                Toast.makeText(this@FooterListActivity, "Hey I am a footer", Toast.LENGTH_SHORT).show()
            }
        })
    }
}