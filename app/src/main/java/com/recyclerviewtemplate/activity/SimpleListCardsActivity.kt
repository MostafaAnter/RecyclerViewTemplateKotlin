...
import com.recyclerviewtemplate.adapter.SimpleListCardsAdapter
import java.util.*

class SimpleListCardsActivity : AppCompatActivity() {
    private var recyclerView: RecyclerView? = null
    private var toolbar: Toolbar? = null
    private var swipeRefreshRecyclerList: SwipeRefreshLayout? = null
    private var fab: FloatingActionButton? = null
    private var mAdapter: SimpleListCardsAdapter? = null
    ...
    private fun setAdapter() {
        ...
        mAdapter = SimpleListCardsAdapter(this@SimpleListCardsActivity, modelList)
        ...
        mAdapter!!.SetOnItemClickListener(object : SimpleListCardsAdapter.OnItemClickListener {
            override fun onItemClick(view: View?, position: Int, model: AbstractModel?) {

                //handle item click events here
                Toast.makeText(this@SimpleListCardsActivity, "Hey " + model!!.title, Toast.LENGTH_SHORT).show()
            }
        })
    }
}