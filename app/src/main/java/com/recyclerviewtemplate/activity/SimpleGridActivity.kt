...
import com.recyclerviewtemplate.adapter.SimpleGridAdapter
import java.util.*
...
class SimpleGridActivity : AppCompatActivity() {
    ...
    private var mAdapter: SimpleGridAdapter? = null
    ...
    private fun setAdapter() {
        ...
        mAdapter = SimpleGridAdapter(this@SimpleGridActivity, modelList)
        recyclerView!!.setHasFixedSize(true)
        val layoutManager = GridLayoutManager(this@SimpleGridActivity, 2)
        recyclerView!!.layoutManager = layoutManager
        recyclerView!!.adapter = mAdapter
        scrollListener = object : RecyclerViewScrollListener() {
            override fun onEndOfScrollReached(rv: RecyclerView?) {
                Toast.makeText(this@SimpleGridActivity, "End of the RecyclerView reached. Do your pagination stuff here", Toast.LENGTH_SHORT).show()
        ...
        /*
          ...
          */mAdapter!!.SetOnItemClickListener(object : SimpleGridAdapter.OnItemClickListener {
            override fun onItemClick(view: View?, position: Int, model: AbstractModel?) {

                //handle item click events here
                Toast.makeText(this@SimpleGridActivity, "Hey " + model!!.title, Toast.LENGTH_SHORT).show()
            }
        })
    }
}