...
import com.recyclerviewtemplate.adapter.BannerListAdapter
import java.util.*
...
class BannerListActivity : AppCompatActivity() {
    ...
    private var mAdapter: BannerListAdapter? = null
    ...
    private fun setAdapter() {
        ...
        mAdapter = BannerListAdapter(this@BannerListActivity, modelList)
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(this@BannerListActivity, R.drawable.divider_recyclerview)!!)
        recyclerView!!.addItemDecoration(dividerItemDecoration)
        recyclerView!!.adapter = mAdapter
        mAdapter!!.SetOnItemClickListener(object : BannerListAdapter.OnItemClickListener {
            override fun onItemClick(view: View?, position: Int, model: AbstractModel?) {

                //handle item click events here
                Toast.makeText(this@BannerListActivity, "Hey " + model!!.title, Toast.LENGTH_SHORT).show()
            }
        })
    }
}