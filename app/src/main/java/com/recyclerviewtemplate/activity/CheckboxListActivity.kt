...
import com.recyclerviewtemplate.adapter.CheckboxListAdapter
import java.util.*

class CheckboxListActivity : AppCompatActivity() {
    private var recyclerView: RecyclerView? = null
    private var toolbar: Toolbar? = null
    private var swipeRefreshRecyclerList: SwipeRefreshLayout? = null
    private var fab: FloatingActionButton? = null
    private var mAdapter: CheckboxListAdapter? = null
    ...
    private fun setAdapter() {
        ...
        mAdapter = CheckboxListAdapter(this@CheckboxListActivity, modelList)
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(this@CheckboxListActivity, R.drawable.divider_recyclerview)!!)
        recyclerView!!.addItemDecoration(dividerItemDecoration)
        recyclerView!!.adapter = mAdapter
        mAdapter!!.SetOnItemClickListener(object : CheckboxListAdapter.OnItemClickListener {
            override fun onItemClick(view: View?, position: Int, model: AbstractModel?) {

                //handle item click events here
                Toast.makeText(this@CheckboxListActivity, "Hey " + model!!.title, Toast.LENGTH_SHORT).show()
            }
        })
        mAdapter!!.SetOnCheckedListener(object : CheckboxListAdapter.OnCheckedListener {
            override fun onChecked(view: View?, isChecked: Boolean, position: Int, model: AbstractModel?) {
                Toast.makeText(this@CheckboxListActivity, (if (isChecked) "Checked " else "Unchecked ") + model!!.title, Toast.LENGTH_SHORT).show()
            }
        })
    }
}