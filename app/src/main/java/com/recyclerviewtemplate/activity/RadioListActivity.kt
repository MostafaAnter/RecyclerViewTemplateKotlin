...
import com.recyclerviewtemplate.adapter.RadioListAdapter
import java.util.*
...
class RadioListActivity : AppCompatActivity() {
    ...
    private var mAdapter: RadioListAdapter? = null
    ...
    private fun setAdapter() {
        ...
        mAdapter = RadioListAdapter(this@RadioListActivity, modelList)
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(this@RadioListActivity, R.drawable.divider_recyclerview)!!)
        recyclerView!!.addItemDecoration(dividerItemDecoration)
        recyclerView!!.adapter = mAdapter
        mAdapter!!.SetOnItemClickListener(object : RadioListAdapter.OnItemClickListener {
            override fun onItemClick(view: View?, position: Int, model: AbstractModel?) {

                //handle item click events here
                Toast.makeText(this@RadioListActivity, "Hey " + model!!.title, Toast.LENGTH_SHORT).show()
            }
        })
    }
}