...
import com.recyclerviewtemplate.adapter.HeaderListAdapter
import java.util.*
...
class HeaderListActivity : AppCompatActivity() {
    ...
    private var mAdapter: HeaderListAdapter? = null
    ...
    private fun setAdapter() {
        ...
        mAdapter = HeaderListAdapter(this@HeaderListActivity, modelList, "Header")
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(this@HeaderListActivity, R.drawable.divider_recyclerview)!!)
        recyclerView!!.addItemDecoration(dividerItemDecoration)
        recyclerView!!.adapter = mAdapter
        mAdapter!!.SetOnItemClickListener(object : HeaderListAdapter.OnItemClickListener {
            override fun onItemClick(view: View?, position: Int, model: AbstractModel?) {

                //handle item click events here
                Toast.makeText(this@HeaderListActivity, "Hey " + model!!.title, Toast.LENGTH_SHORT).show()
            }
        })
        mAdapter!!.SetOnHeaderClickListener(object : HeaderListAdapter.OnHeaderClickListener {
            override fun onHeaderClick(view: View?, headerTitle: String?) {

                //handle item click events here
                Toast.makeText(this@HeaderListActivity, "Hey I am a header", Toast.LENGTH_SHORT).show()
            }
        })
    }
}